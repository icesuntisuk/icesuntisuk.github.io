...
1. WEP (Wired Equivalent Privacy) มีการเข้ารหัสโดยใช้ Algorithm RC4 ซึ่งเป็นการเข้ารหัสแบบ Symmetric Key Stream โดยจะมีขั้นตอนการใ้ช้งานระหว่าง Client และ Access Point ดังนี้
  ...
  - ช่องโหว่ของ WEP
    ...
    ```
2. WPA นั้นถูกพัฒนาเพื่อแก้ไขจุดอ่อนของ WEP มีความปลอดภัยกว่า WEP เพราะใช้ Algorithm ที่แข็งแกร่งกว่า RC4 ซึ่ง WPA นั้นมี Algorithm หลายตัวให้เลือกเช่น TKIP (Temporal Key Integrity Protocol) เป็นต้น ซึ่ง WPA นั้นมีการเข้ารหัสแบบ Dynamic Key Distribution และรวมถึงการตรวจสอบการเข้าใช้ (Authentication)โดยใช้ 4-Ways Handshake ซึ่งใช้มาตรฐาน IEEE802.1x โดยการทำงานของ WPA นั้นจะเป็นแบบ WPA Pre-Shared Key ซึ่งมีระดับความปลอดภัยหลายแบบ เช่น
     - WPA Personal (WPA-PSK) ใช้ Pre Share Key (PSK) เป็นkeyที่ต้องแจกจ่ายให้กับผู้ใช้ทุกคนเพื่อใช้ในการ Authentication
  ...
  - การทำงานโดยปกติของ WPA ที่จะแตกต่างกับ WEP นั้นคือเป็น TKIP + MIC(Message Integrity Code) หมายถึงเปลี่ยน key ที่สำหรับการเข้ารหัสให้กับทุกๆเฟรมข้อมูลของ WEP ทำให้ยากต่อการคาดเดา key ที่ถูกต้อง และใช้ MIC ซึ่งมาแทน ICV เพื่อเพิ่มการป้องกันการปลอมแปลงข้อมูล  และสุดท้ายที่ปรับเปลี่ยนก็คือการเพิ่มความยาวของ IV จาก 24 บิตไปเป็น 48 บิต
